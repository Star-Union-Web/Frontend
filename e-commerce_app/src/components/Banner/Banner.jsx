        ...
        <div className='container'>
            ...
            gap-4 items-center'>
                ...
                <div data-aos="zoom-in">
                    <img src={BannerImg}
                     alt="" 
                     className='w-[300px] sm:w-[400px] h-auto sm:h-[530px]
                ...
                {/* Text Section */}
                <div>
                    <h1 data-aos="zoom-in" className='text-center sm:text-start text-3xl sm:text-4xl mt-6 sm:mt-0 font-bold text-secondary'>
                       Benefit Using Our Product
                    </h1>
                    <p data-aos="zoom-in" className='text-center sm:text-start text-sm  text-gray-500 my-4 mb-14'>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div data-aos="zoom-in" className='flex flex-col gap-2 mt-5'>
